...
import {REMOVE_COMMENT, ADD_COMMENT,GET_POSTS,POST_ERROR ,UPDATE_LIKES,DELETE_POST,ADD_POST,GET_POST} from "../actions/types"
        ...
        case GET_POSTS:
            ...
            case POST_ERROR:
                ...
                case ADD_COMMENT:
                    ...
                    case REMOVE_COMMENT:
                        return{...state,post:{...state.post,comments:state.post.comments.filter(comment=>comment._id!==payload)}}
                default:
                    return state
    }
